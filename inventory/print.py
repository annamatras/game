...
inventory = {'ruby': [3, 'Clothes', 3], 'rope': [8, 'Clothes', 5],
             'potion': [9, 'Other', 5], 'pot': [9, 'Other', 5],
             'por': [9, 'Other', 5], 'ion': [9, 'Other', 5]}
...
def print_inv(inventory):
    ...
    print("{:<15} {:<15} | {:<10} {:<10} {:<10} {:<10}"
          .format('Stats:', '', 'Item Name', 'Item count', 'Weight',
                  'Type'))
    ...
    for key, value in inventory.items():
        ...
        if i == 2:
            print ("{:<15} {:<15} | {:<10} {:<10} {:<10} {:<10}"
                   .format(user_name[0], user_name[1], key, value[0],
                           value[2], value[1]))
            i += 1
            continue
        elif i == 4:
            print ("{:<15} {:<15} | {:<10} {:<10} {:<10} {:<10}"
                   .format(user_life[0], user_life[1], key, value[0], value[2],
                           value[1]))
            i += 1
            continue
        elif i == 6:
            print ("{:<15} {:<15} | {:<10} {:<10} {:<10} {:<10}"
                   .format(user_time_left[0], user_time_left[1],
                           key, value[0], value[2], value[1]))
            i += 1
            continue
        else:
            print ("{:<15} {:<15} | {:<10} {:<10} {:<10} {:<10}"
                   .format(' ', ' ', key, value[0], value[2], value[1]))
